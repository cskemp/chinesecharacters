...
data_file_locations = {
    ...
    "distinctiveness_csv": f"{DISTINCTIVENESS_LOCATION}/all_distinctiveness.csv",
    "persistent_distinctiveness_csv": DISTINCTIVENESS_LOCATION + "/all_distinctiveness_streamed.csv",
