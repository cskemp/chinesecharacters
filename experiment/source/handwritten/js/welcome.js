...
welcome.task = {};
welcome.task.blurb = '<b>"Complexity of Chinese Characters"</b> is a short survey asking you to rate the complexity of Chinese characters.';
welcome.task.time = '10 minutes';
welcome.task.pay = 'GBP $1.70';

// --------------  things that vary between ethics approvals --------------

welcome.ethics = {};
welcome.ethics.approval = '2021-21543-16820-3'
welcome.ethics.name = 'Complexity of Chinese Characters';
welcome.ethics.selection = 'You are invited to complete a survey that asks you to rate the complexity of Chinese characters.  We hope to learn how characters have changed in complexity over time.  You were selected as a possible participant in this study because you accepted the task on Prolific.';
welcome.ethics.description = 'If you decide to participate, you will be presented with pairs of character images. You will need to decide which member of the pair is more complex, and by how much.  The task should take approximately ' + welcome.task.time + ' to complete including reading time.';
...
welcome.section.start =
    ...
    '<p>Thanks for accepting the task. ' + welcome.task.blurb + ' It involves the following steps:</p>' +
    '<ol>' +
    ...
    '<li> At the end, we will give you the completion code you need to get paid for the task.</li>' +
    '</ol>' +
...
welcome.section.consent =
    ...
    'If you like, you can download and read the <a href="./wtf/pls.pdf" target="_blank">Plain Language Statement</a> and <a href="./wtf/consent.pdf" target="_blank">Consent Form.</a>' + 
    '			<p align="center"><b>PARTICIPANT CONSENT</b></p>' + '			By continuing, you are making a decision whether or not to participate.  Clicking the button below indicates that you have decided to participate.' +
    '			<br>' +
    '			<p align="center">' +
    '           <input type="button" id="consentButton" class="consent jspsych-btn" value="Next" onclick="welcome.click.consent()" >' +
    '			</p>' +
    '			<p>To withdraw your consent, simply close the browser tab and return the task. Your data will be deleted from our records.</p>' +
    '		</div><br><br></div>';
