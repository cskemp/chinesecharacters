...
def check_manual_setup() -> bool:
    ...
    #     characters = set()
    #     for filename in os.listdir(f"{config.ROOT}/{config.original_data_file_names['traditional']}"):
    #         image_name, image_type = filename.split(".")
    #         character, image_id = image_name.split("_")
    #         if character not in characters:
    #             os.mkdir(f"{config.data_file_locations['traditional_raw']}/{character}")
    #             characters.add(character)
    #         os.rename(f"{config.ROOT}/{config.original_data_file_names['traditional']}/{filename}", f"{config.data_file_locations['traditional_raw']}/{character}/{image_id}.{image_type}")
